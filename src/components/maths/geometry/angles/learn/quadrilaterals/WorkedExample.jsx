...
// ── WorkedExample ─────────────────────────────────────────────────────────
// Interactive worked example: find the missing angle in a quadrilateral.
    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          background: show ? C.accentDim : "#fff",
          color: C.accent, fontSize: "13px", fontWeight: "700",
          cursor: "pointer", marginBottom: show ? "12px" : 0,
        }}
      >
        ...
        <div>
          {[
            ...
            <div key={i} style={{
              ...
              <p style={{ fontSize: "13px", fontWeight: "700", color: C.text, margin: 0, fontFamily: "monospace" }}>
                {s.working}
              </p>
            </div>
          ))}
