...
// ── QuadDrill ─────────────────────────────────────────────────────────────
// 5-question drill: each question shows a labelled quadrilateral diagram
// and asks the student to find the missing angle x°.
    ...
    <div>
      ...
      <div style={{
        ...
        <QuadSVG
          points={q.points}
          colour={q.colour}
          colourDim={q.colour + "20"}
          labels={q.vertexLabels}
          angles={q.angleLabels}
        />
      </div>
      ...
      <div style={{ background: C.accentDim, borderRadius: "10px", padding: "14px", marginBottom: "14px" }}>
        <p style={{ fontSize: "13px", color: C.text, margin: "0 0 6px", lineHeight: 1.6 }}>
          Find the missing angle <strong>x°</strong>.
        </p>
      ...
      {checked && (
        <div>
          <div style={{
            ...
            <p style={{ fontSize: "13px", fontWeight: "700", color: isRight ? C.green : C.red, margin: "0 0 4px" }}>
